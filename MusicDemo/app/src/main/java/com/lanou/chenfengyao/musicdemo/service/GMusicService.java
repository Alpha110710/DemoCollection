...
//
//    private MusicProviderImpl mMusicProviderImpl;
...
//            PlayBack playback = new CastPlayback(mMusicProviderImpl);
...
//            mSession.setExtras(mSessionExtras);
//            PlayBack playback = new LocalPlayback(mMusicProviderImpl,MusicService.this );
...
////        if (mMusicProviderImpl.isInitialized()) {
////            // if music library is ready, return immediately
////            result.sendResult(mMusicProviderImpl.getChildren(parentMediaId, getResources()));
////        } else {
////            // otherwise, only return results when the music library is retrieved
////            result.detach();
////            mMusicProviderImpl.retrieveMediaAsync(new MusicProviderImpl.Callback() {
////                @Override
...
////        mMusicProviderImpl = new MusicProviderImpl();
////
////        // To make the app more responsive, fetch and cache catalog information now.
////        // This can help improve the response time in the method
////        // {@link #onLoadChildren(String, Result<List<MediaItem>>) onLoadChildren()}.
////        mMusicProviderImpl.retrieveMediaAsync(null /* Callback */);
////
////        mPackageValidator = new PackageValidator(this);
////
////        QueueManager queueManager = new QueueManager(mMusicProviderImpl, getResources(),
...
////                });
////
////        LocalPlayback playback = new LocalPlayback(mMusicProviderImpl,this);
////        mPlaybackManager = new PlaybackManager(this, getResources(), mMusicProviderImpl, queueManager,
////                playback);
////
